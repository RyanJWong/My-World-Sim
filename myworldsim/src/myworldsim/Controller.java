...
public class Controller {
	...
	public Controller() {
		...
		commandInterpreterModel = new CommandInterpreterModel(this);
		...
		if (commandList.size() >0) {
			...
			{
				System.out.println("Controller::Controller(): Unable to create the Binary Search Command Tree. Check SQL Server database.");
	
			}
		}else{
			System.out.println("Controller::Controller(): Unable to create the Binary Search Command Tree. Command List empty. Check SQL Server." );
